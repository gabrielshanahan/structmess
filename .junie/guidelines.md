# Structmess Java/Quarkus Development Guidelines

This guide provides best practices for developing with Java, Kotlin, and Quarkus in the Structmess project.
...
- Organize packages consistently:
   - `io.github.gabrielshanahan.structmess.api` - REST endpoints
   - `io.github.gabrielshanahan.structmess.configuration` - Application configuration
   - `io.github.gabrielshanahan.structmess.domain` - Domain models and business logic
   - `io.github.gabrielshanahan.structmess.messaging` - Message queue infrastructure
